...
CXX_FLAGS = -lspqr -fPIC -ggdb -O3 -Wall -w -std=c++11 -I/usr/include/eigen3 -I/usr/include/suitesparse/ -I.
...
bspline_fit: bspline_fit.o
	${CXX} -lspqr $< -o $@

bspline_fit.o: bspline_fit.cpp
	${CXX} -c -fPIC -ggdb -O3 -Wall -w -std=c++11 -I/usr/include/eigen3 -I/usr/include/suitesparse/ -I. $< -o $@
